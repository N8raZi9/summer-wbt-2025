    ...
    <div style="width: 80%; margin: 0 auto; border: 1px solid #ccc; padding: 20px;">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" style="width: 50%; margin: 0 auto; text-align: left;">
            <fieldset>
                ...
                Name: <input type="text" name="name" value="<?php echo $name; ?>" style="width: 100%;"><hr>
                <p style="color: red;"><?php echo $name_err; ?></p><br>
                Email: <input type="email" name="email" value="<?php echo $email; ?>" style="width: 100%;"><br><hr>
                <p style="color: red;"><?php echo $email_err; ?></p><br>
                User Name: <input type="text" name="username" value="<?php echo $username; ?>" style="width: 100%;"><hr>
                <p style="color: red;"><?php echo $username_err; ?></p><br>
                Password: <input type="password" name="password" style="width: 100%;"><hr>
                <p style="color: red;"><?php echo $password_err; ?></p><br>
                Confirm Password: <input type="password" name="confirm_password" style="width: 100%;"><hr>
